...
<div class="panel panel-default">
    <div class="tab-pane section" id="today">
        <div class="box-title">
        <h2 class="boxstitle">
        ...
        <ul class="nav-tabs">
            <li class="yema">
                <a href="yesterday.php"><strong>مباريات الأمس</strong></a>
            </li>
            <li class="toma">
                <a href="index.php"><strong>مباريات اليوم</strong></a>
            </li>
            <li class="tomat">
                <a href="tomorrow.php"><strong>مباريات الغد</strong></a>
            </li>
        </ul>
...
<?php
$url = "https://shootz.yalla-shoot-tv.live/matches-yesterday/"; // الرابط الذي تريد جلب المحتوى منه
$newDomain = "matches.php?name="; // النطاق الجديد الذي تريد استبداله
...
foreach ($tags as $tag) {
    foreach ($dom->getElementsByTagName($tag) as $element) {
        if ($element->hasAttribute('href')) {
            ...
            $element->setAttribute('href', str_replace("https://shootnn.yalla-shoot-tv.live/matches/", $newDomain, $urlAttr));
        }
...
$className = "albaflex"; // اسم الفئة الذي تريد جلب العناصر بناءً عليه
...
<div class="main section" id="main">
   ...
   <?php
$url = "https://shootz.yalla-shoot-tv.live/matches-yesterday/"; // الرابط الذي تريد جلب المحتوى منه
$newDomain = "blog.php?name="; // النطاق الجديد الذي تريد استبداله
...
$search = ["ahmed","Yalla Shoot", "yalla shoot", "يلا شوت","https://shootz.yalla-shoot-tv.live/"]; // الكلمات التي تريد استبدالها
$replace = ["Bashar","Kora Now", "Kora Now", "كورة الان","blog.php?name="]; // البدائل
...
?>
        <div id="custom_html-2" class="widget_text blogpost widget_custom_html"><div class="textwidget custom-html-widget"></div></div></div>       
   </div>
</div>
      <div>
         <div class="container">
...
// البحث عن العناصر باستخدام اسم الفئة
$className = "tabsbox"; // اسم الفئة الذي تريد جلب العناصر بناءً عليه
$elements = $xpath->query("//*[contains(@class, '$className')]");
...
<!-- Mirrored from shootz.yalla-shoot-tv.live/yallakora/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Aug 2024 14:24:56 GMT -->
</html>
<!-- Dynamic page generated in 0.197 seconds. -->
<!-- Cached page generated by WP-Super-Cache on 2024-08-02 17:18:22 -->
